  ...
  return (
    <div>
      <div className='flex justify-content-between mb-2 items-center'>
        <h1 className='text-1xl font-bold'>Lista de Produtos</h1>
        <TextInput onChange={(e) => setSearchString(e.target.value)} value={searchString} 
          className="w-80" type="text" placeholder="Busca..."
        />
      </div>  
